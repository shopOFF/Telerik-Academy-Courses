namespace _02.DefiningClasses
{
    ...
    public class Structures
    {
        ...
        //(СТОЙНОСТЕН ТИП) ЕДНОТО Е VALUE DATA TYPE(STRUCTURE) това са структури-INT,DOUBLE,DATETIME(всички примитивни типове освен STRING- той е class,НО СЕ ДЪРЖИ КАТО СТРУКТУРА)...)), 
        // тоест когато я подаваме по методи и тн.. наляво надясно тя се копира на ново и на ново .... в паметта и тн...!!!!!!!!!!!!!!!!!!!!!!!!!!!!
        //(РЕФЕРЕНТЕН ТИП) ДРУГОТО Е REFERENCE DATA TYPE() LIST<>, CLASS и тн....), референтните, те не се копират, а се (ползват)
