...
{
    public class MockedTeleportStation : ITeleportStation
    {
        ...
        public MockedTeleportStation(IBusinessOwner owner, IEnumerable<IPath> galacticMap, ILocation location, IResources resources)
        {
            this.owner = owner;
        ...
        internal void ValidateThatTeleportationServiceIsApplicable(IUnit unitToTeleport, ILocation targetLocation, out IPath pathToTheTargetPlanet)
        {
